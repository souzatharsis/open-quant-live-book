...
```{r, echo=FALSE, out.width='50%', fig.align = "center", fig.cap="Life is Random (or Nonlinear?)"}
...
Fig. \@ref(fig:causality-graph1) provides a representation of the causal links in the simulated system.
```{r causality-graph1, echo=FALSE, out.width='50%', fig.align = "center",fig.cap="Interactions between the variables of the simulated linear system."}
knitr::include_graphics("./chapters/TransferEntropy/causality-graph1.png")
```
...
```{r, echo=FALSE, out.width='50%', fig.align = "center", fig.cap="Interactions between the variables of the simulated nonlinear system."}
knitr::include_graphics("./chapters/TransferEntropy/causality-graph2.png")
```
